...
//
// It is used by SparingQuadPlugin across various scheduling extension points, and
// exposes the generalized functionality that should be provided to SparingQuadPlugin.
